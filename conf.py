...
BLOG_TITLE = "ChiPy Coding Workshops"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://chicagopython.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://chicagopython.github.io/"
BLOG_EMAIL = "chicago-sig-organizers@python.org"
BLOG_DESCRIPTION = "The Chicago Python User Group's coding workshops for Python Project Night."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "chicagopython"
